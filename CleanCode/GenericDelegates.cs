...
namespace CleanCode
{
    ...
    public class SampleDelegates
    {
        ...
        {
            Console.WriteLine("Its Generic Action Method");
        }

        public void GenericAction(string para1)
        {
            Console.WriteLine($"Its Generic Action Method : {para1}");
        }

        public void GenericAction(string para1, string para2)
        {
            Console.WriteLine($"Its Generic Action Method : {para1}  {para2}");
        }
